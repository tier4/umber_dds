...
impl Serialize for SPDPdiscoveredParticipantData {
        ...
        S: serde::Serializer,
    {
        ...
        if !self._domain_tag.is_empty() {
            ...
            let str_len = self._domain_tag.len() as u16;
            let serialized_str_len = str_len + 4 + 1; // 4 is length of string, 0 is null
            let pad_len = (4 - serialized_str_len % 4) % 4;
            s.serialize_field::<u16>("parameterLength", &(serialized_str_len + pad_len))?;
            s.serialize_field("domain_tag", &self._domain_tag)?;
            for _ in 0..pad_len {
                s.serialize_field::<u8>("padding", &0)?;
            }
        }
...
mod test {
    ...
    fn test_serialize() {
        ...
        */
        assert_eq!(
            Bytes::from_static(&[
                0x0F, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x15, 0x00, 0x04, 0x00, 0x02, 0x04,
                ...
                ,
