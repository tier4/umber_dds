...
impl EventLoop {
    pub fn new(mut sockets: HashMap::<Token, UdpSocket>, participant_guidprefix: GuidPrefix) -> EventLoop {
        ...
        EventLoop { poll , sockets, message_receiver }
    }
    ...
    fn receiv_packet(udp_sock: &UdpSocket) -> Vec<UdpMessage> {
        ...
        loop {
            ...
            packets.push(UdpMessage {message: packet, addr});
        }
    }
